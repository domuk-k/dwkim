...
나의 관점은 사람의 마인드셋에 초점이 있다. AI-native 사고방식, 협업자로서의 관계, **설계자/오케스트레이터로서의 역할**을 말한다.
...
- [game-to-ai-creation-dopamine-loop](/game-to-ai-creation-dopamine-loop/) - 프로슈머와 인지 부하의 역설
- [Plan을 위한 Plan](/meta-plan-agent-philosophy) - 계획-리뷰 핑퐁의 이론적 기초
- [delegation-requires-decomposition](/delegation-requires-decomposition/) - 쪼갤 수 있어야 위임할 수 있다
- [llm-is-sensor-not-decision-maker](/llm-is-sensor-not-decision-maker/) - LLM은 센서다, 의사결정자가 아니다
