...
- [static-connascence-and-type-systems](/static-connascence-and-type-systems/) - 이 글의 "Any는 해상도가 낮다"를 아키텍처 용어로 재정의: Any = 동적 동변성 증가
- [anthropic-typescript-bet](/anthropic-typescript-bet/) - Anthropic이 TypeScript에 올인하는 이유도 정적 동변성의 이점
