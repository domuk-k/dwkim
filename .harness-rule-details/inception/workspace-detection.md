...
**Purpose**: Determine workspace state and check for existing Harness projects

## Step 1: Check for Existing Harness Project

Check if `harness-docs/harness-state.md` exists:
...
- Identify workspace root directory (NOT harness-docs/)
...
- Check for existing reverse engineering artifacts in `harness-docs/inception/reverse-engineering/`
...
Create `harness-docs/harness-state.md`:
...
## Code Location Rules
- **Application Code**: Workspace root (NEVER in harness-docs/)
- **Documentation**: harness-docs/ only
