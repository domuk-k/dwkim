...
- [ ] Generate `harness-docs/inception/application-design/unit-of-work.md` with unit definitions and responsibilities
- [ ] Generate `harness-docs/inception/application-design/unit-of-work-dependency.md` with dependency matrix
- [ ] Generate `harness-docs/inception/application-design/unit-of-work-story-map.md` mapping stories to units
...
- Save as `harness-docs/inception/plans/unit-of-work-plan.md`
...
- Ask: "**Unit of work plan complete. Review the plan in harness-docs/inception/plans/unit-of-work-plan.md. Ready to proceed to generation?**"
...
- Mark Units Planning complete in harness-state.md
...
- [ ] Read the complete plan from `harness-docs/inception/plans/unit-of-work-plan.md`
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the units generation artifacts at: `harness-docs/inception/application-design/`
...
- Mark Units Generation stage complete in `harness-docs/harness-state.md`
- Update the "Current Status" section
