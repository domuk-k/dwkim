...
- Read unit definition from `harness-docs/inception/application-design/unit-of-work.md`
- Read assigned stories from `harness-docs/inception/application-design/unit-of-work-story-map.md`
...
### Step 4: Store Plan
- Save as `harness-docs/construction/plans/{unit-name}-functional-design-plan.md`
...
- Create `harness-docs/construction/{unit-name}/functional-design/business-logic-model.md`
- Create `harness-docs/construction/{unit-name}/functional-design/business-rules.md`
- Create `harness-docs/construction/{unit-name}/functional-design/domain-entities.md`
- If unit includes frontend/UI: Create `harness-docs/construction/{unit-name}/functional-design/frontend-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the functional design artifacts at: `harness-docs/construction/[unit-name]/functional-design/`
...
- Mark Functional Design stage complete in harness-state.md
