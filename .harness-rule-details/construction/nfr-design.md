...
- Read NFR requirements from `harness-docs/construction/{unit-name}/nfr-requirements/`
...
### Step 4: Store Plan
- Save as `harness-docs/construction/plans/{unit-name}-nfr-design-plan.md`
...
- Create `harness-docs/construction/{unit-name}/nfr-design/nfr-design-patterns.md`
- Create `harness-docs/construction/{unit-name}/nfr-design/logical-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR design at: `harness-docs/construction/[unit-name]/nfr-design/`
...
- Mark NFR Design stage complete in harness-state.md
