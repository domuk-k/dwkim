...
- Read functional design artifacts from `harness-docs/construction/{unit-name}/functional-design/`
...
### Step 4: Store Plan
- Save as `harness-docs/construction/plans/{unit-name}-nfr-requirements-plan.md`
...
- Create `harness-docs/construction/{unit-name}/nfr-requirements/nfr-requirements.md`
- Create `harness-docs/construction/{unit-name}/nfr-requirements/tech-stack-decisions.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR requirements at: `harness-docs/construction/[unit-name]/nfr-requirements/`
...
- Mark NFR Requirements stage complete in harness-state.md
