...
- [ ] Read workspace root and project type from `harness-docs/harness-state.md`
...
- [ ] Document exact paths (never harness-docs/)
...
- [ ] Save complete plan as `harness-docs/construction/plans/{unit-name}-code-generation-plan.md`
...
- [ ] Before asking for approval, log the prompt with timestamp in `harness-docs/audit.md`
...
- [ ] Log the user's approval response with timestamp in `harness-docs/audit.md`
- [ ] Include the exact user response text
- [ ] Mark the approval status clearly

## Step 9: Update Progress
- [ ] Mark Code Generation Part 1 (Planning) complete in `harness-state.md`
...
- [ ] Read the complete plan from `harness-docs/construction/plans/{unit-name}-code-generation-plan.md`
- [ ] Identify the next uncompleted step (first [ ] checkbox)
- [ ] Load the context for that step (unit, dependencies, stories)

## Step 11: Execute Current Step
- [ ] Verify target directory from plan (never harness-docs/)
...
- [ ] Write to correct locations:
  ...
  - **Documentation**: `harness-docs/construction/{unit-name}/code/` (markdown only)
...
- [ ] Update `harness-docs/harness-state.md` current status
...
> - **Documentation**: `harness-docs/construction/[unit-name]/code/`
...
- Mark Code Generation stage as complete for this unit in harness-state.md
...
### Code Location Rules
- **Application code**: Workspace root only (NEVER harness-docs/)
- **Documentation**: harness-docs/ only (markdown summaries)
- **Read workspace root** from harness-state.md before generating code
