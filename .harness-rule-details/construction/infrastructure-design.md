...
- Read functional design from `harness-docs/construction/{unit-name}/functional-design/`
- Read NFR design from `harness-docs/construction/{unit-name}/nfr-design/` (if exists)
...
### Step 4: Store Plan
- Save as `harness-docs/construction/plans/{unit-name}-infrastructure-design-plan.md`
...
- Create `harness-docs/construction/{unit-name}/infrastructure-design/infrastructure-design.md`
- Create `harness-docs/construction/{unit-name}/infrastructure-design/deployment-architecture.md`
- If shared infrastructure: Create `harness-docs/construction/shared-infrastructure.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the infrastructure design at: `harness-docs/construction/[unit-name]/infrastructure-design/`
...
- Mark Infrastructure Design stage complete in harness-state.md
