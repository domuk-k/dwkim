...
When a user returns to continue work on an existing Harness project, present this prompt:

```markdown
**Welcome back! I can see you have an existing Harness project in progress.**

Based on your harness-state.md, here's your current status:
...
1. **Always read harness-state.md first** when detecting existing project
