...
2. ~~(follow-up 2) persona-api 배포 자동화 GH Actions~~ — 완료 2026-04-21 (`deploy-persona-api.yml`, typecheck → flyctl deploy --remote-only → /health verify; `FLY_API_TOKEN` GH secret 1년 만료)
